...
label0= Label(root,text="!!!WELCOME TO GYM MANAGEMENT SYSTEM!!!", font=("Helvetica", 30))
label1=Label(root,text="Name of the Person", font=("Helvetica", 12))
entry1=Entry(root , font=("Helvetica", 12))
label2=Label(root, text="Weight of the Person", font=("Helvetica", 12))
entry2= Entry(root, font=("Helvetica", 12))
label3=Label(root, text="Adhaar No.", font=("Helvetica", 12))
entry3= Entry(root, font=("Helvetica", 12))
label4=Label(root, text="Mobile No.", font=("Helvetica", 12))
entry4= Entry(root, font=("Helvetica", 12))
label5=Label(root, text="Type of Training", font=("Helvetica", 12))
entry5= Entry(root, font=("Helvetica", 12))
button1= Button(root, text="ADD PERSON", bg="blue", fg="white", width=20, font=("Helvetica", 12), command=additem)
button2= Button(root, text="DELETE PERSON", bg="blue", fg="white", width =20, font=("Helvetica", 12), command=deleteitem)
button3= Button(root, text="VIEW FIRST PERSON" , bg="blue", fg="white", width =20, font=("Helvetica", 12), command=firstitem)
button4= Button(root, text="VIEW NEXT PERSON" , bg="blue", fg="white", width =20, font=("Helvetica", 12), command=nextitem)
button5= Button(root, text="VIEW PREVIOUS PERSON", bg="blue", fg="white", width =20, font=("Helvetica", 12), command=previousitem)
button6= Button(root, text="VIEW LAST PERSON", bg="blue", fg="white", width =20, font=("Helvetica", 12), command=lastitem)
button7= Button(root, text="UPDATE PERSON", bg="blue", fg="white", width =20, font=("Helvetica", 12), command=updateitem)
button8= Button(root, text="SEARCH PERSON", bg="blue", fg="white", width =20, font=("Helvetica", 12), command=searchitem)
button9= Button(root, text="CLEAR SCREEN", bg="blue", fg="white", width=20, font=("Helvetica", 12), command=clearitem)
